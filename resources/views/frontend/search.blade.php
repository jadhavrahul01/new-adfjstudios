...
<head>
    ...
    <title>Search - adfj-studios</title>
...
<body>
                    ...
                    <div class="col-xl-12">
                        <div class="search__result-wrapper">
                            <div class="search__result-content text-center mb-40">
                                ...
                                <p>adfj-studios found 46 results for your search query.</p>
                            </div>
                                            ...
                                            <span>
                                                <svg width="20" height="20" viewBox="0 0 20 20"
                                                    ...
                                                    <path
                                                        ...
                                                        stroke="currentColor" stroke-width="1.5"
                                                        stroke-linecap="round" stroke-linejoin="round" />
                                                    <path d="M19.0031 19.0002L17.2031 17.2002" stroke="currentColor"
                        ...
                        <div class="search__blog-item mb-30">
                            <div class="search__blog-content">
                                ...
                                <h3 class="search__blog-title">
                                    <a href="blog-details.html">Beijing winter Olympics: <br />
                                        ...
                                        <span>
                                            <svg width="14" height="14" viewBox="0 0 14 14" fill="none"
                                                ...
                                                <path
                                                    ...
                                                    stroke="#7A7E83" stroke-width="1.5" stroke-linecap="round"
                                                    stroke-linejoin="round"></path>
                                            </svg>
                                            35
                                        </span>
                                        ...
                                        <span>
                                            <svg width="26" height="9" viewBox="0 0 26 9" fill="none"
                                                ...
                                                <path d="M21.6934 1L25 4.20003L21.6934 7.4" stroke="currentColor"
                                                    stroke-width="1.5" stroke-linecap="round"
                                                    stroke-linejoin="round" />
                                                <path d="M0.999999 4.1991H25" stroke="currentColor"
                                                    stroke-width="1.5" stroke-linecap="round"
                                                    stroke-linejoin="round" />
                                            </svg>
                                        </span>
                    ...
                    <div class="col-md-6">
                        <div class="search__blog-item mb-30">
                            <div class="search__blog-content">
                                ...
                                <h3 class="search__blog-title">
                                    <a href="blog-details.html">6 Product launch Email <br />Examples you’ll Want to
                                        Steal.</a>
                                </h3>
                                <p>
                                    Everybody needs to write content for personal or
                    ...
                    <div class="col-md-6">
                        <div class="search__blog-item mb-30">
                            <div class="search__blog-content">
                                ...
                                <h3 class="search__blog-title">
                                    <a href="blog-details.html">Top 10 Digital Marketing Tips to <br />
                    ...
                    <div class="col-md-6">
                        <div class="search__blog-item mb-30">
                            <div class="search__blog-content">
                                ...
                                <h3 class="search__blog-title">
                                    <a href="blog-details.html">Starting and Growing Web <br />
                                        Design in 2022</a>
                                </h3>
                                <p>
                                    Everybody needs to write content for personal or
                    ...
                    <div class="col-md-6">
                        <div class="search__blog-item mb-30">
                            <div class="search__blog-content">
                                ...
                                <h3 class="search__blog-title">
                                    <a href="blog-details.html">Business Meeting 2023 in <br />
                                        San Francisco</a>
                                </h3>
                                <p>
                                    Everybody needs to write content for personal or
    ...
    <!-- footer area start -->
    <footer>
        <div class="footer__area footer__style-blue include-bg bg-luminosity" data-bg-color="footer-bg-blue"
                            ...
                            <div class="col-md-4">
                                <div class="footer__lang d-flex align-items-center justify-content-md-end">
                                    <div class="footer__lang-img mr-15">
                                        <img src="assets/img/footer/footer-lang-flag-1.png" alt="" />
                                    </div>
                                    <div class="footer__lang-wrapper">
                                        <span class="footer__lang-selected-lang tp-lang-toggle-2"
                                            id="tp-footer-lang-toggle">English</span>

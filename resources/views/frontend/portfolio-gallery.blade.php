...
<head>
    ...
    <title>Portfolio Gallery - adfj-studios</title>
        ...
        <div id="loading-center">
            <div id="loading-center-absolute">
                ...
                <div class="preloader__content text-center">
                    ...
                    <h3 class="preloader__title">adfj-studios</h3>
                                        ...
                                        <ul>
                                            <li class="has-dropdown">
                                                ...
                                                <ul class="submenu">
                                                    ...
                                                    <li>
                                                        <a href="home-portfolio.html">Personal Portfolio</a>
                                                    </li>
                                                    <li>
                                                ...
                                                <ul class="mega-menu">
                                                    <li>
                                                        <a href="javasript:void(0);"
                                                            class="mega-menu-title">Widget</a>
                                                        <ul>
                                                            <li>
                                            ...
                                            <li class="has-dropdown">
                                                ...
                                                <ul class="submenu">
                                                    ...
                                                    <li>
                                                        <a href="portfolio-masonary.html">Masonary Full</a>
                                                    </li>
                                                    <li>
                                                    ...
                                                    <li>
                                                        <a href="portfolio-details.html">Classic Details</a>
                                                    </li>
                                                    <li>
                                                        <a href="portfolio-details-list.html">List With Details</a>
                                                    </li>
                                                    <li>
                                                        <a href="portfolio-details-slider.html">Slider with Details</a>
                                                    </li>
                                                    <li>
                                                        <a href="portfolio-details-video.html">Video With Details</a>
                                                    </li>
                                                </ul>
                                            </li>
                                            ...
                                            <li class="has-dropdown">
                                                ...
                                                <ul class="submenu">
                                                    ...
                                                    <li>
                                                        <a href="blog-details-no-sidebar.html">Blog Details 2</a>
                                                    </li>
                                                </ul>
                                            </li>
                                            <li class="has-dropdown has-mega-menu">
    ...
    <main>
        ...
        <section class="portfolio__area pt-110 pb-80 p-relative fix">
            <div class="portfolio__shape">
                ...
                <img class="portfolio__shape-15" src="assets/img/portfolio/grid/shape/circle-sm.png"
                    alt="" />
                <img class="portfolio__shape-16" src="assets/img/portfolio/grid/shape/polygon-yellow.png"
                    alt="" />
                <img class="portfolio__shape-17" src="assets/img/portfolio/grid/shape/polygon-pink.png"
                    alt="" />
                <img class="portfolio__shape-18" src="assets/img/portfolio/grid/shape/polygon-green.png"
                    alt="" />
                <img class="portfolio__shape-19" src="assets/img/portfolio/grid/shape/polygon-green-2.png"
                    alt="" />
            </div>
            <div class="container">
                <div class="row">
                ...
                <div class="row tp-gx-4 grid tp-portfolio-load-more" data-show="9" data-show-item="2">
                    <div class="col-xl-4 col-lg-4 col-md-6 grid-item cat1 cat3">
                        <div class="portfolio__grid-item mb-40 wow fadeInUp" data-wow-delay=".3s"
                            ...
                            <div class="portfolio__grid-thumb w-img fix tp-img-reveal tp-img-reveal-item"
                                data-fx="24" data-meta-tag="Creative" data-title="Visual Identity">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 grid-item cat2 cat4">
                        <div class="portfolio__grid-item mb-40 wow fadeInUp" data-wow-delay=".3s"
                            data-wow-duration="1s">
                            <div class="portfolio__grid-thumb w-img fix tp-img-reveal tp-img-reveal-item"
                                data-fx="24" data-meta-tag="Packaging" data-title="Logo Mockups">
                                <a href="portfolio-details.html">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 grid-item cat3 cat2 cat1">
                        <div class="portfolio__grid-item mb-40 wow fadeInUp" data-wow-delay=".3s"
                            data-wow-duration="1s">
                            <div class="portfolio__grid-thumb w-img fix tp-img-reveal tp-img-reveal-item"
                                data-fx="24" data-meta-tag="Apps" data-title="Pattern Inspired">
                                <a href="portfolio-details.html">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 grid-item cat4 cat1">
                        <div class="portfolio__grid-item mb-40 wow fadeInUp" data-wow-delay=".3s"
                            data-wow-duration="1s">
                            <div class="portfolio__grid-thumb w-img fix tp-img-reveal tp-img-reveal-item"
                                data-fx="24" data-meta-tag="Branding" data-title="Product Design">
                                <a href="portfolio-details.html">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 grid-item cat5 cat3">
                        <div class="portfolio__grid-item mb-40 wow fadeInUp" data-wow-delay=".3s"
                            data-wow-duration="1s">
                            <div class="portfolio__grid-thumb w-img fix tp-img-reveal tp-img-reveal-item"
                                data-fx="24" data-meta-tag="Creative" data-title="Original Coffee">
                                <a href="portfolio-details.html">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 grid-item cat2 cat1">
                        <div class="portfolio__grid-item mb-40 wow fadeInUp" data-wow-delay=".3s"
                            data-wow-duration="1s">
                            <div class="portfolio__grid-thumb w-img fix tp-img-reveal tp-img-reveal-item"
                                data-fx="24" data-meta-tag="Development" data-title="UX Web Design">
                                <a href="portfolio-details.html">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 grid-item cat1 cat2">
                        <div class="portfolio__grid-item mb-40 wow fadeInUp" data-wow-delay=".3s"
                            data-wow-duration="1s">
                            <div class="portfolio__grid-thumb w-img fix tp-img-reveal tp-img-reveal-item"
                                data-fx="24" data-meta-tag="Creative" data-title="Magazine Cover">
                                <a href="portfolio-details.html">
                                    <img src="assets/img/portfolio/grid/portfolio-grid-7.jpg" alt="" />
                                </a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-6 grid-item cat3 cat5">
                        <div class="portfolio__grid-item mb-40 wow fadeInUp" data-wow-delay=".3s"
                            data-wow-duration="1s">
                            <div class="portfolio__grid-thumb w-img fix tp-img-reveal tp-img-reveal-item"
                                data-fx="24" data-meta-tag="Decoration" data-title="Visual Identity">
                                <a href="portfolio-details.html">
                                    <img src="assets/img/portfolio/grid/portfolio-grid-8.jpg" alt="" />
                                </a>
                                <div class="portfolio__grid-video">
                                    <a href="https://www.youtube.com/watch?v=go7QYaQR494&amp;t=3s"
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 grid-item cat5 cat4">
                        <div class="portfolio__grid-item mb-40 wow fadeInUp" data-wow-delay=".3s"
                            data-wow-duration="1s">
                            <div class="portfolio__grid-thumb w-img fix tp-img-reveal tp-img-reveal-item"
                                data-fx="24" data-meta-tag="UI/UX" data-title="Website Template">
                                <a href="portfolio-details.html">
                                    <img src="assets/img/portfolio/grid/portfolio-grid-9.jpg" alt="" />
                                </a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-6 grid-item cat5 cat4">
                        <div class="portfolio__grid-item mb-40 wow fadeInUp" data-wow-delay=".3s"
                            ...
                            <div class="portfolio__grid-thumb w-img fix tp-img-reveal tp-img-reveal-item"
                                data-fx="24" data-meta-tag="UI/UX" data-title="Website Template">
                                <a href="portfolio-details.html">
                                    <img src="assets/img/portfolio/grid/portfolio-grid-10.jpg" alt="" />
                                </a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-6 grid-item cat5 cat4">
                        <div class="portfolio__grid-item mb-40 wow fadeInUp" data-wow-delay=".3s"
                            ...
                            <div class="portfolio__grid-thumb w-img fix tp-img-reveal tp-img-reveal-item"
                                data-fx="24" data-meta-tag="UI/UX" data-title="Website Template">
                                <a href="portfolio-details.html">
                                    <img src="assets/img/portfolio/grid/portfolio-grid-11.jpg" alt="" />
                                </a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-6 grid-item cat5 cat4">
                        <div class="portfolio__grid-item mb-40 wow fadeInUp" data-wow-delay=".3s"
                            ...
                            <div class="portfolio__grid-thumb w-img fix tp-img-reveal tp-img-reveal-item"
                                data-fx="24" data-meta-tag="UI/UX" data-title="Website Template">
                                <a href="portfolio-details.html">
                                    <img src="assets/img/portfolio/grid/portfolio-grid-12.jpg" alt="" />
                                </a>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="footer__info">
                                        ...
                                        <div class="footer__contact">
                                            <div class="footer__contact-call">
                                                <span><a href="tel:624-423-26-72"><i class="fa-solid fa-phone"></i>
                                                        +624 423 26
                                                        72</a></span>
                                            </div>
                                            <div class="footer__contact-mail">
                                                <span><a
                                                        href="mailto:support@adfj-studios.com">support@adfj-studios.com</a></span>
                                            </div>
                                        </div>
                                ...
                                <div class="footer__widget-content">
                                    <div class="footer__app mb-30">
                                        <div class="footer__app-item">
                                            <a href="#" class="tp-btn-app"><svg width="15" height="16"
                                        ...
                                        <div class="footer__app-item">
                                            <a href="#" class="tp-btn-app"><svg width="13" height="17"
                                    ...
                                    <div class="footer__qrcode d-flex align-items-center">
                                        ...
                                        <div class="footer__qrcode-content">
                                            <p>
                                                <a class="popup-image" href="assets/img/icon/qrcode.png">Scan to
                                                    Download The Themes</a>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="footer__copyright">
                                    <p>
                                        <a href="home-main.html">© 2022 adfj-studios</a> All Rights
                                        Reserved.
                                    </p>
                                </div>
                            </div>
